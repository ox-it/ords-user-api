 ...
 */
package uk.ac.ox.it.ords.api.user.resources.documentation;
...
public class Swagger extends Swagger2Feature {
	...
	public Swagger(){
		super();
		this.setBasePath("/api/1.0/user/");
		this.setDescription("API for managing ORDS users");
		this.setTitle("ORDS User API");
		this.setVersion("1.0");
